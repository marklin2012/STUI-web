...
export default class Wave extends React.Component<WaveProps> {
  ...
  onClick = (node: HTMLElement, waveColor: string) => {
    ...
    extraNode.className = `${rootPrefixCls}-click-animating-node`
    ...
    if (
      ...
      styleForPseudo = updateCSS(
        `[${rootPrefixCls}-click-animating-without-extra-node='true']::after, .${rootPrefixCls}-click-animating-node {
  ...
  getAttributeName() {
    ...
    return insertExtraNode
      ? `${rootPrefixCls}-click-animating`
      : `${rootPrefixCls}-click-animating-without-extra-node`
  }
